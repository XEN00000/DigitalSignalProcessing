...
\subsection{Wpływ częstotliwości próbkowania i metody rekonstrukcji na jakość sygnału}
Celem tego eksperymentu jest zbadanie wpływu doboru częstotliwości próbkowania oraz metody konwersji C/A na błędy rekonstrukcji.\cite{1}.
