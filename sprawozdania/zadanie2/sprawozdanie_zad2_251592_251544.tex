...
Cel: udowodnienie, że niedostateczna częstotliwość próbkowania sprawia, iż nie da się odróżnić sygnału $f_0$ od sygnału $f_d$, gdzie $f_d = f_0 + k f_s$.
...
\subsection{Zjawisko aliasingu w pasmach częstotliwościowych}
...
%     \includegraphics[width=0.48\linewidth]{exp3/sygnal_100hz_org.png}
%     \includegraphics[width=0.48\linewidth]{exp3/sygnal_100hz_rek.png}
%     \caption{Po lewej: Oryginalny sygnał ciągły 100 Hz. Po prawej: Zrekonstruowany sygnał (próbkowanie 1000 Hz).}
...
%     \centering
%     % UWAGA: Wygeneruj wykresy w programie i podmień nazwy plików
%     \includegraphics[width=0.48\linewidth]{exp3/sygnal_1100hz_org.png}
%     \includegraphics[width=0.48\linewidth]{exp3/sygnal_1100hz_rek.png}
%     \caption{Po lewej: Oryginalny sygnał ciągły 1100 Hz. Po prawej: Zrekonstruowany sygnał (próbkowanie 1000 Hz).}
