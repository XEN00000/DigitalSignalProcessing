...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
        ...
        \multicolumn{2}{|c|}{\textit{Parametry generatora sygnału}} \\ \hline
        Amplituda ($A$) & 1.0 \\ \hline
        Czas początkowy ($t_1$) [s] & 0.0 \\ \hline
        Czas trwania ($d$) [s] & 0.05 \\ \hline
        Częstotliwość ($f_{gen}$) [kHz] & 10.0 \\ \hline
        Częstotliwość sygnału $f_0$ [Hz] & \textbf{100.0} \\ \hline
        Przesunięcie fazowe [rad] & 0.0 \\ \hline
        
        \multicolumn{2}{|c|}{\textit{Parametry konwersji (A/C i C/A)}} \\ \hline
        Częstotliwość próbkowania $f_s$ [Hz] & 1000.0 \\ \hline
        Liczba bitów kwantyzacji (b) & 16 \\ \hline
        Metoda rekonstrukcji & Sinc (okno = 20) \\ \hline
    \end{tabular}
